  ...
  return (
    <div className={classes.Container}>
      ...
      <div className={classes.Details}>
        ...
        <p>
          Desi viata noastra de zi cu zi este ocupata aici la CompleCurat, este
        ...
        <p>
          Gandirea este destul de simpla. La CompleCurat, credem ca angajatii
      ...
      <div className={classes.Details}>
        ...
        <p>
          Noi, cei de la CompleCurat, am dori sa deschidem usile lumii noastre,
